...
from mani_skill.envs.tasks.tabletop.corn_in_basket import CornBasketEnvNew
...
@register_env("Corn-Basket-Eval", max_episode_steps=200)
class CornInBasketEvalEnv(CornBasketEnvNew):
    """
