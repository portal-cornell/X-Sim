...
from mani_skill.envs.tasks.tabletop.default_real2sim_template import DefaultReal2SimEnv
...
@register_env("Default-Eval", max_episode_steps=100)
class DefaultEvalEnv(DefaultReal2SimEnv):
    """
    ...
    def __init__(self, *args, randomize_lighting=False, randomize_camera=False, **kwargs):        
        ...
        self.default_eye = np.array([0.10742855, 0.5960838, 1.11373567])
        self.default_target = np.array([0.68296728, 0.14237866, 0.43336311])
