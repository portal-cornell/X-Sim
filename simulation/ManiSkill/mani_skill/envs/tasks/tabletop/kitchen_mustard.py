...
@register_env("Kitchen-Mustard", max_episode_steps=200)
class KitchenMustardEnv(BaseEnv):
    ...
    env_to_data_map = {
            ...
            "flat_kitchen": {
                ...
                "robot_qpos": [-0.05109641, -0.6162801 , -0.13139507, -2.4170141 , -0.15964197, 1.8990761 ,  0.73566496, 0.04, 0.04],
                "camera": {
