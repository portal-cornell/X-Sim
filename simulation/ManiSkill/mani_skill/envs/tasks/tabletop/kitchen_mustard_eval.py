...
from mani_skill.envs.tasks.tabletop.kitchen_mustard import KitchenMustardEnv
...
@register_env("Mustard-Eval", max_episode_steps=100)
class KitchenMustardEvalEnv(KitchenMustardEnv):
    """
