...
from mani_skill.envs.tasks.tabletop.pot_on_burner import PotOnBurnerEnv
...
@register_env("Pot-On-Burner-Eval", max_episode_steps=200)
class PotOnBurnerEvalEnv(PotOnBurnerEnv):
    """
    ...
    def evaluate(self):
        ...
        for i, obj_mesh in enumerate(self.obj_meshes):
            if i == self.single_obj_pick_place_idx:
                ...
                is_tcp_near_obj = tcp_obj_distance <= 0.05
        info.update({
