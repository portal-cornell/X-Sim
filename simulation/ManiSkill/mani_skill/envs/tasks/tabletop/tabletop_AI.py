...
@register_env("Tabletop-AI", max_episode_steps=50)
class TabletopAIEnv(BaseEnv):
    ...
    env_to_data_map = {
            "tabletop": {
                ...
                "camera": {
                    "eye": [0.11364682, 0.61086124, 1.10074165],
                    "target": [0.69425251, 0.12618053, 0.4465386]
                },
                "ground_altitude": -0.7,
            },
            "flat_kitchen": {
    ...
    def __init__(
        ...
        *args,
        ...
        demo_name='AI',
        num_waypoints=2,
        first_waypoint_idx=32,
        last_waypoint_idx=64,
        goal_thresh = 0.05,
        angle_goal_thresh = 0.25,
        visualize=False,
    ...
    def load_obj(self, scene, obj_file, name="obj", kinematic=False):
        ...
        if not kinematic:
            ...
            material.static_friction = self.obj_static_friction
            material.dynamic_friction = self.obj_dynamic_friction
            builder.add_multiple_convex_collisions_from_file(
                filename=obj_file,
                material=material,
                density=density,
