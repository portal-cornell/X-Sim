...
from mani_skill.envs.tasks.tabletop.tabletop_AI import TabletopAIEnv
...
@register_env("Tabletop-AI-Eval", max_episode_steps=100)
class TabletopAIEvalEnv(TabletopAIEnv):
    """
    ...
    def evaluate(self):
        ...
        for i, obj_mesh in enumerate(self.obj_meshes):
            if i == self.single_obj_pick_place_idx:
                ...
                is_tcp_near_obj = tcp_obj_distance <= 0.02
        info.update({
