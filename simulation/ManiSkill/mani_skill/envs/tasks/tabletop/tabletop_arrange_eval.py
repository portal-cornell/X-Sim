...
from mani_skill.envs.tasks.tabletop.tabletop_arrange import TabletopArrangeEnv
...
@register_env("Tabletop-Arrange-Eval", max_episode_steps=100)
class TabletopArrangeEvalEnv(TabletopArrangeEnv):
    """
    ...
    def __init__(self, *args, randomize_lighting=False, randomize_camera=False, **kwargs):        
        ...
        self.default_eye = np.array([0.95304242, -0.07714972 + 0.1,  0.97090369])
        self.default_target = np.array([0.49877198, 0.09168973, 0.09618567])
