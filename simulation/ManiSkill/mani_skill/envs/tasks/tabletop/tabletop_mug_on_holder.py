...
@register_env("Tabletop-Mug-On-Holder", max_episode_steps=100)
class TabletopMugOnHolderEnv(BaseEnv):
    ...
    def __init__(
        ...
        *args,
        ...
        obj_noise=0.0,
        environment_name="tabletop",
        obj_names=['cup', 'mug_holder'],  
        pick_place_idx=0,
        randomize_objects_list=[0],
        demo_name='mug_on_holder',
        num_waypoints=5,
        first_waypoint_idx=24,
        last_waypoint_idx=60,
        goal_thresh = 0.05,
    ...
    def load_obj(self, scene, obj_file, name="obj", kinematic=False):
        ...
        builder.initial_pose = sapien.Pose()
        if kinematic or name == "mug_holder":
