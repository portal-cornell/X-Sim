...
from mani_skill.envs.tasks.tabletop.tabletop_shoe_on_rack_copy import TabletopShoeOnRackCopyEnv
...
@register_env("Tabletop-Shoe-On-Rack-Secondview-Eval", max_episode_steps=100)
class TabletopShoeOnRackEval2Env(TabletopShoeOnRackCopyEnv):
    """
    ...
    def __init__(self, *args, randomize_lighting=False, randomize_camera=False, **kwargs):        
        ...
        self.default_eye = np.array([-0.14951116,  0.42141752,  0.66512583])
        self.default_target = np.array([0.76664266, 0.29555655, 0.28457203])
