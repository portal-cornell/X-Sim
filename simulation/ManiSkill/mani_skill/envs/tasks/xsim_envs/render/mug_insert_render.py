...
from mani_skill.envs.tasks.xsim_envs.mug_insert import MugInsertEnv
...
@register_env("Mug-Insert-Eval", max_episode_steps=100)
class MugInsertEvalEnv(MugInsertEnv):
    """
    Evaluation version of MugInsertEnv that terminates episodes when success is reached.
    
    This environment extends the refactored MugInsertEnv with lighting and camera randomization
