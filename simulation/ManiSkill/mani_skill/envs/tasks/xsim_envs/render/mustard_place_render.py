...
from mani_skill.envs.tasks.xsim_envs.mustard_place import MustardPlaceEnv
...
@register_env("Mustard-Place-Eval", max_episode_steps=100)
class MustardPlaceEvalEnv(MustardPlaceEnv):
    """
    Evaluation version of MustardPlaceEnv that terminates episodes when success is reached.
    
    This environment extends the refactored MustardPlaceEnv with lighting and camera randomization
