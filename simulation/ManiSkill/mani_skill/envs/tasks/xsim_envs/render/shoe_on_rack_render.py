...
from mani_skill.envs.tasks.xsim_envs.shoe_on_rack import ShoeOnRackEnv
...
@register_env("Shoe-on-Rack-Eval", max_episode_steps=100)
class ShoeOnRackEvalEnv(ShoeOnRackEnv):
    """
    Evaluation version of ShoeOnRackEnv that terminates episodes when success is reached.
    
    This environment extends the refactored ShoeOnRackEnv with lighting and camera randomization
