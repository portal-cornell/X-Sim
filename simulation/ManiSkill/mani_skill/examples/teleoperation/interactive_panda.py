...
def solve(env: BaseEnv, debug=False, vis=False):
    ...
    elif env.unwrapped.robot_uids == "panda" or env.unwrapped.robot_uids == "panda_wristcam" or env.unwrapped.robot_uids == "panda_ninja":
    ...
    while True:
        ...
        if execute_current_pose:
            ...
            elif env.unwrapped.robot_uids == "panda_ninja":
                result = planner.move_to_pose_with_screw(transform_window._gizmo_pose * sapien.Pose([0, 0, 0.2]), dry_run=True)
